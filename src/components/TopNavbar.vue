  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        <li class="nav-item"><router-link to="/" class="nav-link px-2 active" aria-current="page">Каталог</router-link></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Оплата</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Помощь</a></li>
